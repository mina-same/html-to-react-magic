...
<div id="app">
  ...
  <aside className="sidebar">
    <div className="sb-logo">
      ...
      <div className="sb-logo-text">
        ...
        <div className="sb-logo-sub">SAAID PLATFORM</div>
      </div>
    </div>
    <div className="sb-assoc">
      <div className="sb-av" id="sbav">ج</div>
      <div>
        <div className="sb-aname" id="sbAssocName">اسم الجمعية</div>
        <span className="sb-atag">جمعية خيرية</span>
      </div>
    </div>
    <nav className="sb-nav">
      ...
      <button className="sbi" onClick={(event) => { try { (new Function('event', "showPage('profile',this)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}><span className="sbi-ic">📋</span> ملف الجمعية <span className="sbi-badge green">AI</span></button>
      <div className="sb-sec">الإدارة</div>
      <button className="sbi" onClick={(event) => { try { (new Function('event', "showPage('team',this)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}><span className="sbi-ic">👥</span> الفريق</button>
      <button className="sbi" onClick={(event) => { try { (new Function('event', "showPage('tasks',this)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}><span className="sbi-ic">✅</span> المهام <span className="sbi-badge red" id="sb-urgent-count">2</span></button>
      <button className="sbi" onClick={(event) => { try { (new Function('event', "showPage('donations',this)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}><span className="sbi-ic">💳</span> التبرعات</button>
      <div className="sb-sec">المحتوى</div>
      <button className="sbi" onClick={(event) => { try { (new Function('event', "showPage('content',this)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}><span className="sbi-ic">✦</span> محتوى تسويقي</button>
      <button className="sbi" onClick={(event) => { try { (new Function('event', "showPage('campaigns',this)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}><span className="sbi-ic">📣</span> الحملات</button>
      ...
      <div className="sb-sec">الخدمات</div>
      <button className="sbi" onClick={(event) => { try { (new Function('event', "showPage('services',this)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}><span className="sbi-ic">🛎</span> خدماتنا</button>
      <button className="sbi" onClick={(event) => { try { (new Function('event', "showPage('analytics',this)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}><span className="sbi-ic">📊</span> التحليلات</button>
      <div className="sb-sec">الإعدادات</div>
      <button className="sbi" onClick={(event) => { try { (new Function('event', "showPage('settings',this)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}><span className="sbi-ic">⚙</span> الإعدادات</button>
    </nav>
    <div className="sb-bot">
      <button className="sbi" style={{"color":"rgba(255,100,100,.5)","fontSize":".83rem"}} onClick={(event) => { try { (new Function('event', "sessionStorage.removeItem('saaid_user'); sessionStorage.removeItem('saaid_devAccess'); window.location.href='dashboard.html'")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}><span className="sbi-ic">⬡</span> تسجيل الخروج</button>
    </div>
  </aside>
  ...
  <div className="main">
    <header className="topbar">
      ...
      <div className="tb-assoc-name" id="topAssocName">أهلاً — سجّل بياناتك أولاً</div>
      <div className="tb-notif">🔔<div className="tb-dot"></div></div>
    </header>
    ...
    <div className="content">
      ...
      <div className="page active" id="page-overview">
        <div className="welcome-banner">
          ...
          <div className="wb-text">
            <div className="wb-greeting">مرحباً بكم في منصة ساعِد</div>
            <div className="wb-name" id="bannerName">أهلاً بجمعيتكم الكريمة</div>
            <div className="wb-sub">ارفعوا ملف الجمعية لبدء توليد المحتوى التسويقي بالذكاء الاصطناعي</div>
          </div>
          <div className="wb-status">
            <div className="wb-dot"></div>
            <span className="wb-stxt">متصل</span>
          </div>
        </div>

        <div className="stats-row">
          <div className="stat-card">
            <div className="stat-num" id="statFollowers">—</div>
            <div className="stat-label">متابع على المنصات</div>
            <div className="stat-change">+ ابدأ بتفعيل حسابك</div>
          </div>
          <div className="stat-card">
            <div className="stat-num" id="statDonations">—</div>
            <div className="stat-label">تبرعات هذا الشهر</div>
            <div className="stat-change">+ ابدأ حملتك الأولى</div>
          </div>
          <div className="stat-card">
            <div className="stat-num" id="statContent">0</div>
            <div className="stat-label">قطعة محتوى مُنتجة</div>
            <div className="stat-change">+ ارفع الملف التعريفي</div>
          </div>
          <div className="stat-card">
            <div className="stat-num">5</div>
            <div className="stat-label">خدمات متاحة لك</div>
            <div className="stat-change" style={{"color":"var(--g3)"}}>✓ جاهزة للتفعيل</div>
          </div>
        </div>
        ...
        <div className="section-card">
          <div className="sc-header">
            ...
            <div>
              <div className="sc-title">ابدأ هنا</div>
              <div className="sc-sub">ارفع ملف جمعيتك التعريفي ليحلله الذكاء الاصطناعي</div>
            </div>
          </div>
          <div className="sc-body">
            <div style={{"display":"flex","gap":"12px","flexWrap":"wrap"}}>
              <div onClick={(event) => { try { (new Function('event', "showPage('profile',document.querySelector('.sbi:nth-child(2)'))")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} style={{"flex":"1","minWidth":"220px","background":"var(--g5)","borderRadius":"10px","padding":"16px","cursor":"pointer","border":"1px solid rgba(45,122,82,.12)","transition":"all .2s"}} onMouseover={(event) => { try { (new Function('event', "this.style.background='#d4eddf'")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} onMouseout={(event) => { try { (new Function('event', "this.style.background='var(--g5)'")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>
                <div style={{"fontSize":"1.5rem","marginBottom":"6px"}}>📋</div>
                <div style={{"fontSize":".88rem","fontWeight":"700","color":"var(--g2)","marginBottom":"3px"}}>رفع الملف التعريفي</div>
                <div style={{"fontSize":".78rem","color":"var(--tl)"}}>PDF أو Word — يحلله AI فوراً</div>
              </div>
              <div onClick={(event) => { try { (new Function('event', "showPage('services',document.querySelectorAll('.sbi')[5])")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} style={{"flex":"1","minWidth":"220px","background":"#fff8f0","borderRadius":"10px","padding":"16px","cursor":"pointer","border":"1px solid rgba(201,168,76,.15)","transition":"all .2s"}} onMouseover={(event) => { try { (new Function('event', "this.style.background='#fdeee0'")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} onMouseout={(event) => { try { (new Function('event', "this.style.background='#fff8f0'")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>
                <div style={{"fontSize":"1.5rem","marginBottom":"6px"}}>🛎</div>
                <div style={{"fontSize":".88rem","fontWeight":"700","color":"#92400e","marginBottom":"3px"}}>استعرض خدماتنا</div>
                <div style={{"fontSize":".78rem","color":"var(--tl)"}}>5 خدمات متكاملة للجمعيات</div>
              </div>
              <div onClick={(event) => { try { (new Function('event', "showPage('campaigns',document.querySelectorAll('.sbi')[4])")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} style={{"flex":"1","minWidth":"220px","background":"#f0f4ff","borderRadius":"10px","padding":"16px","cursor":"pointer","border":"1px solid rgba(99,102,241,.12)","transition":"all .2s"}} onMouseover={(event) => { try { (new Function('event', "this.style.background='#e0e7ff'")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} onMouseout={(event) => { try { (new Function('event', "this.style.background='#f0f4ff'")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>
                <div style={{"fontSize":"1.5rem","marginBottom":"6px"}}>📣</div>
                <div style={{"fontSize":".88rem","fontWeight":"700","color":"#3730a3","marginBottom":"3px"}}>ابدأ حملة</div>
                <div style={{"fontSize":".78rem","color":"var(--tl)"}}>حملات رمضان، التبرع، التوعية</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="page" id="page-profile">
        ...
        <div className="section-card">
          <div className="sc-header">
            <div className="sc-icon">📤</div>
            <div>
              <div className="sc-title">ملف الجمعية التعريفي</div>
              <div className="sc-sub">ارفع الملف وسيقوم الذكاء الاصطناعي بتحليله وتوليد المحتوى</div>
            </div>
            <span className="sc-badge ai">✦ مدعوم بـ AI</span>
          </div>
          <div className="sc-body">
            {/* Name input */}
            <div style={{"marginBottom":"14px"}}>
              <label style={{"display":"block","fontSize":".82rem","fontWeight":"600","color":"var(--tm)","marginBottom":"5px"}}>اسم الجمعية</label>
              <input type="text" id="assocNameInput" placeholder="مثال: جمعية تكاتف الخيرية" style={{"width":"100%","padding":"10px 13px","borderRadius":"var(--rs)","border":"1.5px solid var(--border)","fontFamily":"'Tajawal',sans-serif","fontSize":".93rem","color":"var(--td)","outline":"none","background":"white","transition":"border-color .2s"}} onFocus={(event) => { try { (new Function('event', "this.style.borderColor='var(--g3)'")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} onBlur={(event) => { try { (new Function('event', "this.style.borderColor='var(--border)'")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} />
            </div>

            <div className="upload-zone" id="uploadZone" ondragover="dragOver(event)" ondragleave="dragLeave(event)" ondrop="dropFile(event)">
              <div className="uz-icon">📄</div>
              <div className="uz-title">اسحب الملف هنا أو اضغط للرفع</div>
              <div className="uz-sub">الملف التعريفي للجمعية، التقرير السنوي، أو أي وثيقة تعريفية</div>
              <div className="uz-types">
                <span className="uz-type">PDF</span>
                <span className="uz-type">Word</span>
                <span className="uz-type">TXT</span>
                <span className="uz-type">صور JPG/PNG</span>
              </div>
              <input type="file" id="fileInput" accept=".pdf,.doc,.docx,.txt,.jpg,.jpeg,.png" onChange={(event) => { try { (new Function('event', "fileSelected(this)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} />
            </div>

            <div className="file-preview" id="filePreview">
              <div className="fp-icon" id="fpIcon">📄</div>
              <div>
                <div className="fp-name" id="fpName">—</div>
                <div className="fp-size" id="fpSize">—</div>
              </div>
              <span className="fp-remove" onClick={(event) => { try { (new Function('event', "removeFile()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>✕ إزالة</span>
            </div>

            {/* Text fallback */}
            <div style={{"marginTop":"14px"}}>
              <label style={{"display":"block","fontSize":".82rem","fontWeight":"600","color":"var(--tm)","marginBottom":"5px"}}>أو أكتب وصف الجمعية مباشرة</label>
              <textarea id="assocDesc" placeholder="أكتب هنا نبذة عن الجمعية، مجال عملها، مشاريعها، وأهدافها..." style={{"width":"100%","padding":"11px 13px","borderRadius":"var(--rs)","border":"1.5px solid var(--border)","fontFamily":"'Tajawal',sans-serif","fontSize":".87rem","color":"var(--td)","outline":"none","background":"white","resize":"vertical","minHeight":"90px","lineHeight":"1.65","transition":"border-color .2s"}} onFocus={(event) => { try { (new Function('event', "this.style.borderColor='var(--g3)'")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} onBlur={(event) => { try { (new Function('event', "this.style.borderColor='var(--border)'")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}></textarea>
            </div>

            <button className="ai-btn" id="analyzeBtn" onClick={(event) => { try { (new Function('event', "analyzeProfile()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>
        ...
        <div className="ai-loading" id="aiLoading">
          ...
          <div className="al-text">يجري الذكاء الاصطناعي التحليل...</div>
          <div className="al-step" id="aiStep">جاري قراءة الملف التعريفي</div>
        </div>
        ...
        <div className="ai-results" id="aiResults">
          ...
          <div className="section-card">
            <div className="sc-header">
              <div className="sc-icon">✦</div>
              <div>
                <div className="sc-title">ملخص الجمعية</div>
                <div className="sc-sub">تحليل AI للملف التعريفي</div>
              </div>
            </div>
            <div className="sc-body">
              <div className="summary-box">
                <div className="summary-label">✦ ملخص تلقائي</div>
                <div className="summary-text" id="aiSummary">—</div>
              </div>
            </div>
          </div>
          ...
          <div className="section-card">
            <div className="sc-header">
              <div className="sc-icon">💡</div>
              <div>
                <div className="sc-title">أفكار وتحديات تسويقية</div>
                <div className="sc-sub">توصيات AI لتحسين الحضور الإعلامي</div>
              </div>
            </div>
            <div className="sc-body">
              <div className="ip-grid">
                <div className="ip-card">
                  <div className="ip-card-head ideas">
                    <span className="ip-head-icon">💡</span>
                    <span className="ip-head-title">أفكار للمحتوى التسويقي</span>
                  </div>
                  <div className="ip-body" id="ideasList">—</div>
                </div>
                <div className="ip-card">
                  <div className="ip-card-head pain">
                    <span className="ip-head-icon">⚠️</span>
                    <span className="ip-head-title">تحديات ونقاط ضعف إعلامية</span>
                  </div>
                  <div className="ip-body" id="painList">—</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="section-card">
            <div className="sc-header">
              ...
              <div>
                <div className="sc-title">محتوى تسويقي مقترح</div>
                <div className="sc-sub">محتوى جاهز للنشر مُولَّد بالذكاء الاصطناعي</div>
              </div>
            </div>
            <div className="sc-body">
              <div className="content-tabs">
                <button className="ctab active" onClick={(event) => { try { (new Function('event', "switchTab(this,'post')")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>منشور سوشيال</button>
                <button className="ctab" onClick={(event) => { try { (new Function('event', "switchTab(this,'story')")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>قصة إنسانية</button>
                <button className="ctab" onClick={(event) => { try { (new Function('event', "switchTab(this,'donation')")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>نداء تبرع</button>
              </div>
              <div className="content-area" id="contentDisplay">
                <button className="copy-btn" onClick={(event) => { try { (new Function('event', "copyContent()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>نسخ</button>
                <span id="contentText">—</span>
              </div>
              <button className="regen-btn" onClick={(event) => { try { (new Function('event', "regenContent()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>🔄 توليد نص جديد</button>
            </div>
          </div>

        </div>
        {/* placeholder before analysis */}
        <div className="ai-placeholder" id="aiPlaceholder">
          <div className="ap-icon">✦</div>
          <div className="ap-text">ارفع الملف التعريفي أو اكتب وصف الجمعية لبدء التحليل</div>
        </div>
      </div>
      ...
      <div className="page" id="page-team">
        <div className="section-card">
          <div className="sc-header">
            <div className="sc-icon">👥</div>
            <div>
              <div className="sc-title">الفريق</div>
              <div className="sc-sub" id="emp-sub-count">7 موظفين</div>
            </div>
            <div style={{"marginRight":"auto","display":"flex","gap":"8px","alignItems":"center"}}>
              <span id="active-emp-badge" style={{"fontSize":".72rem","background":"#dcfce7","color":"#166534","padding":"2px 9px","borderRadius":"20px","fontWeight":"600"}}>4 نشطين</span>
              <button onClick={(event) => { try { (new Function('event', "openAddEmployee()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} style={{"padding":"6px 14px","borderRadius":"var(--rs)","background":"var(--g3)","color":"white","border":"none","fontFamily":"'Tajawal',sans-serif","fontSize":".78rem","fontWeight":"700","cursor":"pointer"}}>+ إضافة موظف</button>
            </div>
          </div>
          <div className="emp-list" id="employeesList"></div>
        </div>
      </div>

      {/* ===== PAGE: TASKS ===== */}
      <div className="page" id="page-tasks">
        <div className="section-card">
          <div className="sc-header">
            <div className="sc-icon">✅</div>
            <div>
              <div className="sc-title">لوحة المهام</div>
              <div className="sc-sub">Notion-style Kanban</div>
            </div>
            <div style={{"marginRight":"auto","display":"flex","gap":"8px","alignItems":"center"}}>
              <span id="kpi-urgent-sub" style={{"fontSize":".72rem","background":"#fef3c7","color":"#92400e","padding":"2px 9px","borderRadius":"20px","fontWeight":"600"}}>⚡ 2 عاجلة</span>
              <button onClick={(event) => { try { (new Function('event', "openTaskModal(null)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} className="task-add-btn">+ مهمة جديدة</button>
            </div>
          </div>
          <div className="task-toolbar">
            <button className="task-filter-btn active" onClick={(event) => { try { (new Function('event', "setTaskFilter('all',this)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>الكل</button>
            <button className="task-filter-btn" onClick={(event) => { try { (new Function('event', "setTaskFilter('urgent',this)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>⚡ عاجلة</button>
            <button className="task-filter-btn" onClick={(event) => { try { (new Function('event', "setTaskFilter('overdue',this)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>⏰ متأخرة</button>
            <button className="task-filter-btn" onClick={(event) => { try { (new Function('event', "setTaskFilter('mine',this)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>👤 الخاصة بي</button>
            <select id="assigneeFilter" onChange={(event) => { try { (new Function('event', "renderBoard()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} style={{"padding":"4px 10px","borderRadius":"20px","border":"1px solid var(--border)","fontFamily":"'Tajawal',sans-serif","fontSize":".74rem","color":"var(--tl)","background":"white","marginRight":"auto"}}>
          ...
          <div className="kanban-board">
            <div className="kanban-col">
              <div className="kanban-col-head todo">
                ...
                <span className="kanban-col-title">لم تبدأ</span>
                <span className="kanban-col-count" id="col-count-todo">0</span>
              </div>
              <div className="kanban-cards" id="col-todo"></div>
            </div>
            <div className="kanban-col">
              <div className="kanban-col-head doing">
                <span style={{"width":"8px","height":"8px","borderRadius":"50%","background":"#f59e0b","flexShrink":"0"}}></span>
                <span className="kanban-col-title">قيد التنفيذ</span>
                <span className="kanban-col-count" id="col-count-doing">0</span>
              </div>
              <div className="kanban-cards" id="col-doing"></div>
            </div>
            <div className="kanban-col">
              <div className="kanban-col-head done">
                <span style={{"width":"8px","height":"8px","borderRadius":"50%","background":"var(--g3)","flexShrink":"0"}}></span>
                <span className="kanban-col-title">مكتملة</span>
                <span className="kanban-col-count" id="col-count-done">0</span>
              </div>
              <div className="kanban-cards" id="col-done"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* ===== PAGE: DONATIONS ===== */}
      <div className="page" id="page-donations">
        <div style={{"display":"grid","gridTemplateColumns":"repeat(4,1fr)","gap":"11px","marginBottom":"18px"}}>
          <div className="stat-card" style={{"borderRight":"3px solid #3b82f6"}}>
            <div className="stat-num" style={{"color":"#1e40af"}}>48,500</div>
            <div className="stat-label">تبرعات هذا الشهر (ر.س)</div>
            <div className="stat-change" style={{"color":"#2563eb"}}>↑ 18% عن السابق</div>
          </div>
          <div className="stat-card" style={{"borderRight":"3px solid var(--g3)"}}>
            <div className="stat-num" style={{"color":"var(--g2)"}}>134</div>
            <div className="stat-label">متبرع نشط</div>
            <div className="stat-change">↑ 22 جديد هذا الشهر</div>
          </div>
          <div className="stat-card" style={{"borderRight":"3px solid #f59e0b"}}>
            <div className="stat-num" style={{"color":"#92400e"}}>2</div>
            <div className="stat-label">تبرعات معلقة</div>
            <div className="stat-change" style={{"color":"#d97706"}}>⚡ تحتاج متابعة</div>
          </div>
          <div className="stat-card" style={{"borderRight":"3px solid #8b5cf6"}}>
            <div className="stat-num" style={{"color":"#5b21b6"}}>20,000</div>
            <div className="stat-label">أعلى تبرع (ر.س)</div>
            <div className="stat-change" style={{"color":"#7c3aed"}}>شيك — مؤسسة الأمل</div>
          </div>
        </div>
        <div className="section-card">
          <div className="sc-header" style={{"flexWrap":"wrap","gap":"8px"}}>
            <div className="sc-icon">💳</div>
            <div>
              <div className="sc-title">سجل التبرعات</div>
              <div className="sc-sub" id="don-sub-count">جميع التبرعات</div>
            </div>
            <div style={{"marginRight":"auto","display":"flex","gap":"7px","flexWrap":"wrap","alignItems":"center"}}>
              <select id="donPeriodFilter" onChange={(event) => { try { (new Function('event', "renderDonations()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} style={{"padding":"5px 10px","borderRadius":"var(--rs)","border":"1px solid var(--border)","fontFamily":"'Tajawal',sans-serif","fontSize":".76rem","color":"var(--tm)","background":"white"}}>
              ...
              <select id="donFilter" onChange={(event) => { try { (new Function('event', "renderDonations()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} style={{"padding":"5px 10px","borderRadius":"var(--rs)","border":"1px solid var(--border)","fontFamily":"'Tajawal',sans-serif","fontSize":".76rem","color":"var(--tm)","background":"white"}}>
          ...
          <div className="sc-body" style={{"padding":"0"}}>
            <table className="don-table">
              <thead>
                <tr>
                  <th className="don-th">المتبرع</th>
                  <th className="don-th">المبلغ</th>
                  <th className="don-th">القناة</th>
                  <th className="don-th">التاريخ</th>
                  <th className="don-th">الحالة</th>
                </tr>
              </thead>
      ...
      {/* TASK MODAL */}
      <div className="modal-overlay hidden" id="taskModalOverlay" onClick={(event) => { try { (new Function('event', "closeTaskModalIfOutside(event)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>
        <div className="task-modal" id="taskModal">
          <div className="modal-header">
            <span className="modal-status-badge todo" id="modalStatusBadge">لم تبدأ</span>
            <input className="modal-title" id="modalTitle" placeholder="عنوان المهمة..." type="text" />
            <button className="modal-close" onClick={(event) => { try { (new Function('event', "closeTaskModal()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>✕</button>
          </div>
          <div className="modal-body">
            <div className="modal-row">
              <div className="modal-field">
                <label>الحالة</label>
                <select className="modal-select" id="modalStatus" onChange={(event) => { try { (new Function('event', "updateModalStatusBadge()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>
              ...
              <div className="modal-field">
                ...
                <select className="modal-select" id="modalUrgency">
            ...
            <div className="modal-row">
              <div className="modal-field">
                <label>المسؤول</label>
                <select className="modal-select" id="modalAssignee">
                  <option value="">غير محدد</option>
                </select>
              </div>
              <div className="modal-field">
                <label>الموعد النهائي</label>
                <input className="modal-input" id="modalDeadline" type="date" />
              </div>
            </div>
            <div className="modal-field">
              <label>التصنيف</label>
              <select className="modal-select" id="modalCategory">
            ...
            <div className="modal-field">
              <label>ملاحظات</label>
              <textarea className="modal-textarea" id="modalNotes" placeholder="تفاصيل إضافية..."></textarea>
            </div>
          </div>
          <div className="modal-footer">
            <button className="modal-btn-danger" id="modalDeleteBtn" onClick={(event) => { try { (new Function('event', "deleteCurrentTask()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>حذف</button>
            <button className="modal-btn-secondary" onClick={(event) => { try { (new Function('event', "closeTaskModal()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>إلغاء</button>
            <button className="modal-btn-primary" onClick={(event) => { try { (new Function('event', "saveTask()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>حفظ المهمة</button>
          </div>
        </div>
      </div>

      {/* ADD EMPLOYEE MODAL */}
      <div className="modal-overlay hidden" id="empModalOverlay" onClick={(event) => { try { (new Function('event', "closeEmpModalIfOutside(event)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>
        <div className="task-modal" style={{"width":"400px"}}>
          <div className="modal-header">
            <span className="modal-status-badge doing">موظف جديد</span>
            <span style={{"flex":"1","fontSize":".95rem","fontWeight":"700","color":"var(--td)","paddingRight":"8px"}}>إضافة فرد للفريق</span>
            <button className="modal-close" onClick={(event) => { try { (new Function('event', "closeEmpModal()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>✕</button>
          </div>
          <div className="modal-body">
            <div className="modal-field">
              <label>الاسم الكامل</label>
              <input className="modal-input" id="empNameInput" placeholder="مثال: سارة العمري" type="text" />
            </div>
            <div className="modal-field">
              <label>المسمى الوظيفي</label>
              <input className="modal-input" id="empRoleInput" placeholder="مثال: مدير تسويق" type="text" />
            </div>
            <div className="modal-field">
              <label>الحالة</label>
              <select className="modal-select" id="empStatusInput">
          ...
          <div className="modal-footer">
            <button className="modal-btn-secondary" onClick={(event) => { try { (new Function('event', "closeEmpModal()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>إلغاء</button>
            <button className="modal-btn-primary" onClick={(event) => { try { (new Function('event', "saveEmployee()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>إضافة للفريق</button>
          </div>
        </div>
      </div>
      ...
      <div className="page" id="page-content">
        <div className="section-card">
          <div className="sc-header">
            <div className="sc-icon">✍️</div>
            <div>
              <div className="sc-title">استوديو المحتوى التسويقي</div>
              <div className="sc-sub">أنواع متعددة من المحتوى بالذكاء الاصطناعي</div>
            </div>
            <span className="sc-badge ai">✦ AI</span>
          </div>
          <div className="sc-body">
            <div id="contentPageBody">
              <div className="ai-placeholder">
                <div className="ap-icon">✦</div>
                <div className="ap-text">أكمل تحليل ملف الجمعية أولاً من صفحة "ملف الجمعية"</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="page" id="page-influencers">
        ...
        <div style={{"display":"grid","gridTemplateColumns":"repeat(4,1fr)","gap":"11px","marginBottom":"18px"}}>
          <div className="stat-card" style={{"borderRight":"3px solid #8b5cf6"}}>
            <div className="stat-num" style={{"color":"#5b21b6"}} id="inf-kpi-total">6</div>
            <div className="stat-label">مؤثر متعاقد</div>
            <div className="stat-change" style={{"color":"#7c3aed"}} id="inf-kpi-active">4 نشطون حالياً</div>
          </div>
          <div className="stat-card" style={{"borderRight":"3px solid #ec4899"}}>
            <div className="stat-num" style={{"color":"#be185d"}} id="inf-kpi-reach">2.4M</div>
            <div className="stat-label">إجمالي المتابعين</div>
            <div className="stat-change" style={{"color":"#db2777"}}>عبر كل المنصات</div>
          </div>
          <div className="stat-card" style={{"borderRight":"3px solid #f59e0b"}}>
            <div className="stat-num" style={{"color":"#92400e"}} id="inf-kpi-campaigns">8</div>
            <div className="stat-label">حملة مُنفَّذة</div>
            <div className="stat-change" style={{"color":"#d97706"}}>هذا العام</div>
          </div>
          <div className="stat-card" style={{"borderRight":"3px solid var(--g3)"}}>
            <div className="stat-num" style={{"color":"var(--g2)"}} id="inf-kpi-eng">4.2%</div>
            <div className="stat-label">متوسط التفاعل</div>
            <div className="stat-change">↑ أعلى من المتوسط</div>
          </div>
        </div>
        ...
        <div className="section-card">
          <div className="sc-header">
            <div className="sc-icon">⭐</div>
            <div>
              <div className="sc-title">المؤثرون المتاحون للحملات</div>
              <div className="sc-sub" id="inf-sub-count">4 مؤثر متاح</div>
            </div>
            <div style={{"marginRight":"auto","display":"flex","gap":"7px","alignItems":"center"}}>
              <select id="infPlatformFilter" onChange={(event) => { try { (new Function('event', "renderInfluencers()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} style={{"padding":"5px 10px","borderRadius":"var(--rs)","border":"1px solid var(--border)","fontFamily":"'Tajawal',sans-serif","fontSize":".76rem","color":"var(--tm)","background":"white"}}>
              ...
              <select id="infStatusFilter" onChange={(event) => { try { (new Function('event', "renderInfluencers()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} style={{"padding":"5px 10px","borderRadius":"var(--rs)","border":"1px solid var(--border)","fontFamily":"'Tajawal',sans-serif","fontSize":".76rem","color":"var(--tm)","background":"white"}}>
                <option value="all">كل الحالات</option>
                <option value="active">نشط</option>
                <option value="pending">قيد التفاوض</option>
                <option value="ended">انتهى العقد</option>
              </select>
              <button onClick={(event) => { try { (new Function('event', "openInfluencerModal(null)")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} style={{"padding":"6px 14px","borderRadius":"var(--rs)","background":"var(--g3)","color":"white","border":"none","fontFamily":"'Tajawal',sans-serif","fontSize":".78rem","fontWeight":"700","cursor":"pointer"}}>+ إضافة مؤثر</button>
            </div>
          </div>

          {/* Influencers Grid */}
          <div className="sc-body">
            <div id="influencersGrid" style={{"display":"grid","gridTemplateColumns":"repeat(3,1fr)","gap":"14px"}}></div>
          </div>
        </div>
      </div>
      ...
      <div className="modal-overlay hidden" id="campReqOverlay" onClick={(event) => { try { (new Function('event', "if(event.target===this)closeCampReq()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>
        <div className="task-modal" style={{"width":"500px"}}>
          <div className="modal-header">
            <span className="modal-status-badge doing">طلب حملة جديدة</span>
            <span style={{"flex":"1","fontSize":".95rem","fontWeight":"700","color":"var(--td)","paddingRight":"10px"}} id="campReqTitle">—</span>
            <button className="modal-close" onClick={(event) => { try { (new Function('event', "closeCampReq()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>✕</button>
          </div>
          <div className="modal-body">

            {/* Influencer summary */}
            <div id="campReqInfCard" style={{"background":"var(--g6)","borderRadius":"10px","padding":"14px 16px","marginBottom":"18px","display":"flex","alignItems":"center","gap":"12px","border":"1px solid var(--border)"}}>
              <div id="campReqAvatar" style={{"width":"42px","height":"42px","borderRadius":"50%","display":"flex","alignItems":"center","justifyContent":"center","fontSize":"1rem","fontWeight":"700","color":"white","flexShrink":"0"}}></div>
              <div>
                <div id="campReqInfName" style={{"fontSize":".9rem","fontWeight":"700","color":"var(--td)"}}></div>
                <div id="campReqInfMeta" style={{"fontSize":".77rem","color":"var(--tl)","marginTop":"2px"}}></div>
              </div>
              <div style={{"marginRight":"auto","textAlign":"left"}}>
                <div style={{"fontSize":".7rem","color":"var(--tl)"}}>يبدأ من</div>
                <div id="campReqPrice" style={{"fontSize":"1.1rem","fontWeight":"800","color":"var(--g2)"}}></div>
              </div>
            </div>
            ...
            <div className="modal-row">
              <div className="modal-field">
                ...
                <select className="modal-select" id="campType">
              ...
              <div className="modal-field">
                ...
                <input className="modal-input" id="campBudget" type="number" placeholder="مثال: 500" dir="ltr" min="250" />
              </div>
            </div>
            ...
            <div className="modal-row">
              <div className="modal-field">
                ...
                <input className="modal-input" id="campStartDate" type="date" />
              </div>
              <div className="modal-field">
                <label>مدة الحملة</label>
                <select className="modal-select" id="campDuration">
            ...
            <div className="modal-field">
              ...
              <textarea className="modal-textarea" id="campMessage" placeholder="اكتب هنا ما تريد إيصاله من الحملة، وأي تفاصيل تساعد المؤثر على فهم رسالتكم..." style={{"minHeight":"90px"}}></textarea>
            </div>

            {/* Price note */}
            <div style={{"background":"#fff8f0","border":"1px solid rgba(201,168,76,.2)","borderRadius":"8px","padding":"11px 14px","fontSize":".8rem","color":"#92400e","lineHeight":"1.6"}}>
          ...
          <div className="modal-footer">
            <button className="modal-btn-secondary" onClick={(event) => { try { (new Function('event', "closeCampReq()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>إلغاء</button>
            <button className="modal-btn-primary" onClick={(event) => { try { (new Function('event', "submitCampRequest()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>إرسال الطلب ←</button>
          </div>
        </div>
      </div>

      {/* INFLUENCER MODAL */}
      <div className="modal-overlay hidden" id="infModalOverlay" onClick={(event) => { try { (new Function('event', "if(event.target===this)closeInfModal()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>
        <div className="task-modal" style={{"width":"480px"}}>
          <div className="modal-header">
            <span className="modal-status-badge doing" id="infModalBadge">مؤثر جديد</span>
            <span style={{"flex":"1","fontSize":".95rem","fontWeight":"700","color":"var(--td)","paddingRight":"8px"}} id="infModalTitleLabel">إضافة مؤثر</span>
            <button className="modal-close" onClick={(event) => { try { (new Function('event', "closeInfModal()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>✕</button>
          </div>
          <div className="modal-body">
            <div className="modal-row">
              <div className="modal-field">
                <label>الاسم / الحساب</label>
                <input className="modal-input" id="inf-name" placeholder="اسم المؤثر" type="text" />
              </div>
              <div className="modal-field">
                <label>المنصة الرئيسية</label>
                <select className="modal-select" id="inf-platform">
            ...
            <div className="modal-row">
              <div className="modal-field">
                ...
                <input className="modal-input" id="inf-followers" placeholder="مثال: 150000" type="number" dir="ltr" />
              </div>
              <div className="modal-field">
                <label>نسبة التفاعل %</label>
                <input className="modal-input" id="inf-engagement" placeholder="مثال: 4.5" type="number" step="0.1" dir="ltr" />
              </div>
            </div>
            <div className="modal-row">
              <div className="modal-field">
                <label>حالة العقد</label>
                <select className="modal-select" id="inf-status">
                  <option value="active">نشط</option>
                  <option value="pending">قيد التفاوض</option>
                  <option value="ended">انتهى العقد</option>
                </select>
              ...
              <div className="modal-field">
                ...
                <input className="modal-input" id="inf-campaigns" placeholder="0" type="number" dir="ltr" />
              </div>
            </div>
            <div className="modal-field">
              <label>تخصص المحتوى</label>
              <input className="modal-input" id="inf-niche" placeholder="مثال: محتوى خيري، ديني، عائلي..." type="text" />
            </div>
            <div className="modal-field">
              <label>ملاحظات</label>
              <textarea className="modal-textarea" id="inf-notes" placeholder="شروط العقد، تواريخ، ملاحظات..."></textarea>
            </div>
          </div>
          <div className="modal-footer">
            <button className="modal-btn-danger" id="infDeleteBtn" onClick={(event) => { try { (new Function('event', "deleteInfluencer()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }} style={{"display":"none"}}>حذف</button>
            <button className="modal-btn-secondary" onClick={(event) => { try { (new Function('event', "closeInfModal()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>إلغاء</button>
            <button className="modal-btn-primary" onClick={(event) => { try { (new Function('event', "saveInfluencer()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>حفظ</button>
          </div>
        </div>
      </div>
      ...
      <div className="page" id="page-campaigns">
        <div className="welcome-banner">
          ...
          <div className="wb-text">
            <div className="wb-greeting">الحملات الإعلامية</div>
            <div className="wb-name">حملاتك القادمة</div>
            <div className="wb-sub">خطط لحملاتك الموسمية مسبقاً</div>
          </div>
        </div>
        <div className="section-card">
          <div className="sc-body" style={{"textAlign":"center","padding":"40px"}}>
            <div style={{"fontSize":"2rem","marginBottom":"10px"}}>📣</div>
            <div style={{"fontSize":".92rem","fontWeight":"600","color":"var(--tm)","marginBottom":"5px"}}>الحملات قيد الإنشاء</div>
            <div style={{"fontSize":".8rem","color":"var(--tl)"}}>سيتم تفعيل هذه الصفحة بعد تحليل ملف الجمعية</div>
          </div>
        </div>
      </div>
      ...
      <div className="page" id="page-analytics">
        <div className="section-card">
          <div className="sc-body" style={{"textAlign":"center","padding":"40px"}}>
            <div style={{"fontSize":"2rem","marginBottom":"10px"}}>📊</div>
            <div style={{"fontSize":".92rem","fontWeight":"600","color":"var(--tm)","marginBottom":"5px"}}>التحليلات قادمة قريباً</div>
            <div style={{"fontSize":".8rem","color":"var(--tl)"}}>لوحة تحليلات متكاملة لأداء منصاتك</div>
          </div>
        </div>
      </div>
      ...
      <div className="page" id="page-services">
        <div className="welcome-banner" style={{"marginBottom":"22px"}}>
          <div className="wb-icon">🛎</div>
          <div className="wb-text">
            <div className="wb-greeting">خدمات ساعِد الإعلامية</div>
            <div className="wb-name">5 خدمات متكاملة لجمعيتكم</div>
            <div className="wb-sub">اختاروا الخدمة المناسبة وسيتواصل معكم فريقنا</div>
          </div>
        </div>
        <div className="services-grid" id="servicesGrid">
          <div className="srv-card" onClick={(event) => { try { (new Function('event', "toggleService(this,'الظهور الإعلامي وبناء الهوية')")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>
            <div className="srv-icon">📱</div>
            <div className="srv-title">الظهور الإعلامي وبناء الهوية</div>
            <div className="srv-desc">إدارة حسابات التواصل الاجتماعي وبناء الهوية البصرية للجمعية</div>
            <div className="srv-price">يشمل: إدارة المنصات، هوية بصرية، توحيد الرسائل</div>
          </div>
          <div className="srv-card" onClick={(event) => { try { (new Function('event', "toggleService(this,'صناعة المحتوى المؤثر')")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>
            <div className="srv-icon">🎬</div>
            <div className="srv-title">صناعة المحتوى المؤثر</div>
            <div className="srv-desc">محتوى قصصي إنساني، فيديوهات توعوية، تغطيات ميدانية</div>
            <div className="srv-price">يشمل: Storytelling، فيديو، محتوى تفاعلي</div>
          </div>
          <div className="srv-card" onClick={(event) => { try { (new Function('event', "toggleService(this,'تصميم التقارير والملفات')")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>
            <div className="srv-icon">📊</div>
            <div className="srv-title">تصميم التقارير والملفات</div>
            <div className="srv-desc">تصميم الملف التعريفي، تقارير المشاريع، تحويل البيانات لمحتوى بصري</div>
            <div className="srv-price">يشمل: ملفات PDF، موشن جرافيك، إنفوجرافيك</div>
          </div>
          <div className="srv-card" onClick={(event) => { try { (new Function('event', "toggleService(this,'الحملات الإعلامية وجمع التبرعات')")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>
            <div className="srv-icon">💰</div>
            <div className="srv-title">الحملات الإعلامية وجمع التبرعات</div>
            <div className="srv-desc">حملات رمضان، الحج، الأعياد، صفحات هبوط مخصصة للتبرع</div>
            <div className="srv-price">يشمل: حملات موسمية، صفحات هبوط، رسائل تحفيزية</div>
          </div>
          <div className="srv-card" onClick={(event) => { try { (new Function('event', "toggleService(this,'إدارة المؤثرين والشراكات')")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>
            <div className="srv-icon">🤝</div>
            <div className="srv-title">إدارة المؤثرين والشراكات</div>
            <div className="srv-desc">ربط الجمعية بمؤثرين مناسبين، إدارة الحملات، توثيق الشراكات</div>
            <div className="srv-price">يشمل: اختيار المؤثرين، إدارة الحملة، التوثيق</div>
          </div>
          <div className="srv-card" style={{"border":"2px dashed var(--border)","background":"var(--g6)","display":"flex","flexDirection":"column","alignItems":"center","justifyContent":"center","minHeight":"150px"}} onClick={(event) => { try { (new Function('event', "alert('سيتم إضافة المزيد من الخدمات قريباً')")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>
            <div style={{"fontSize":"1.8rem","opacity":".3","marginBottom":"8px"}}>+</div>
            <div style={{"fontSize":".82rem","color":"var(--tl)","textAlign":"center"}}>المزيد قريباً</div>
          </div>
        </div>
        <div id="selectedServices" style={{"display":"none","marginTop":"18px"}}>
          <div className="section-card">
            <div className="sc-header">
              <div className="sc-icon">✓</div>
              <div>
                <div className="sc-title">الخدمات المختارة</div>
                <div className="sc-sub">سيتواصل معكم فريق ساعِد لمناقشة التفاصيل</div>
              </div>
            </div>
            <div className="sc-body">
              <div id="selectedList" style={{"marginBottom":"14px","fontSize":".87rem","color":"var(--tm)","lineHeight":"2"}}></div>
              <button className="ai-btn" onClick={(event) => { try { (new Function('event', "requestServices()")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>إرسال طلب الخدمة ←</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="page" id="page-settings">
        <div className="section-card">
          <div className="sc-header">
            <div className="sc-icon">⚙</div>
            <div><div className="sc-title">إعدادات الجمعية</div></div>
          </div>
          <div className="sc-body">
            <div style={{"display":"grid","gap":"12px"}}>
              <div>
                <label style={{"display":"block","fontSize":".82rem","fontWeight":"600","color":"var(--tm)","marginBottom":"5px"}}>اسم الجمعية</label>
                <input type="text" id="settingsName" placeholder="اسم الجمعية" style={{"width":"100%","padding":"10px 13px","borderRadius":"var(--rs)","border":"1.5px solid var(--border)","fontFamily":"'Tajawal',sans-serif","fontSize":".9rem","color":"var(--td)","outline":"none"}} />
              </div>
              <div>
                <label style={{"display":"block","fontSize":".82rem","fontWeight":"600","color":"var(--tm)","marginBottom":"5px"}}>البريد الإلكتروني للتواصل</label>
                <input type="email" placeholder="email@association.org" style={{"width":"100%","padding":"10px 13px","borderRadius":"var(--rs)","border":"1.5px solid var(--border)","fontFamily":"'Tajawal',sans-serif","fontSize":".9rem","color":"var(--td)","outline":"none"}} />
              </div>
              <button className="ai-btn" style={{"background":"linear-gradient(135deg,#374151,#6b7280)"}} onClick={(event) => { try { (new Function('event', "alert('تم الحفظ')")).call(event.currentTarget, event); } catch(err) { console.error(err); } }}>حفظ الإعدادات</button>
            </div>
          </div>
        </div>
      </div>
