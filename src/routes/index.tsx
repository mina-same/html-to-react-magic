...
<nav>
  ...
  <a href="#cta" className="nav-cta">تواصل معنا</a>
  <a href="dashboard.html" className="nav-login-btn">دخول المنصة ←</a>
</nav>
...
<section className="hero" id="hero">
  ...
  <div className="hero-content fade-up">
    ...
    <h1>
      <span className="accent">ساعِد</span> —
      <br />اليد التي تمتد
      <br />لتصنع أثرًا
    </h1>
    <p className="hero-sub">المساعدة – الأثر قبل الأرقام</p>
    ...
    <div className="hero-btns">
      <a href="#cta" className="btn-primary">ابدأ الشراكة معنا ←</a>
      <a href="dashboard.html" className="btn-login">🔐 دخول المنصة</a>
      <a href="#services" className="btn-secondary">اكتشف خدماتنا</a>
      <a href="https://drive.google.com/file/d/1Woa17q3C2o4_HGd3zdTAVoVzp2NjjeNh/view?usp=drive_link" target="_blank" className="btn-secondary">📄 الملف التعريفي</a>
    </div>
    <div className="hero-stats">
      <div className="stat-item">
        <div className="stat-num">10</div>
        <div className="stat-label">جمعية تحت الإدارة</div>
      </div>
      <div className="stat-item">
        <div className="stat-num">+2M</div>
        <div className="stat-label">ريال تمويلات محققة</div>
      </div>
      <div className="stat-item">
        <div className="stat-num">10K</div>
        <div className="stat-label">ريال تبرعات مجمّعة</div>
      </div>
      <div className="stat-item">
        <div className="stat-num">5</div>
        <div className="stat-label">خدمات متكاملة</div>
      </div>
    </div>
  </div>
  ...
  <div className="hero-visual">
    <div className="hero-logo-wrap">
      ...
      <div className="hero-ring-mid"></div>
      ...
      {/* Sparks */}
      <div className="hero-spark" style={{"width":"4px","height":"4px","left":"30%","top":"70%","animationDuration":"3s","animationDelay":"0s"}}></div>
      <div className="hero-spark" style={{"width":"3px","height":"3px","left":"60%","top":"75%","animationDuration":"4s","animationDelay":"1s"}}></div>
      <div className="hero-spark" style={{"width":"5px","height":"5px","left":"50%","top":"80%","animationDuration":"2.5s","animationDelay":"0.5s"}}></div>
      <div className="hero-spark" style={{"width":"3px","height":"3px","left":"40%","top":"65%","animationDuration":"3.5s","animationDelay":"1.5s"}}></div>
    </div>
  </div>
</section>
...
<section id="about">
  <div className="about-grid">
    <div className="fade-up">
      ...
      <h2 className="section-title">نؤمن أن الخير<br />يستحق أن يُرى</h2>
      ...
      <div className="values-list">
        <div className="value-item"><div className="value-dot"></div><span>الأثر قبل الأرقام</span></div>
        <div className="value-item"><div className="value-dot"></div><span>الشفافية والمصداقية</span></div>
        <div className="value-item"><div className="value-dot"></div><span>الشراكة لا التنفيذ فقط</span></div>
        <div className="value-item"><div className="value-dot"></div><span>الاحترافية في خدمة العمل الخيري</span></div>
        <div className="value-item"><div className="value-dot"></div><span>الإنسان أولًا</span></div>
      </div>
    </div>
...
{/* SERVICES */}
<section id="services">
  <div className="fade-up" style={{"textAlign":"center","maxWidth":"700px","margin":"0 auto 3rem"}}>
  ...
  {/* AI PLATFORM CARD */}
  <div className="ai-platform-card fade-up">
    <div className="ai-platform-badge"><span className="ai-dot"></span>مدعوم بالذكاء الاصطناعي — حصريًا لعملاء ساعِد</div>
    <div className="ai-platform-content">
      <div className="ai-platform-text">
        ...
        <div className="ai-features-grid">
          <div className="ai-feat"><span className="ai-feat-icon">🤖</span><span>توليد محتوى بالذكاء الاصطناعي</span></div>
          <div className="ai-feat"><span className="ai-feat-icon">🖼️</span><span>توليد صور احترافية</span></div>
          <div className="ai-feat"><span className="ai-feat-icon">🎬</span><span>إنتاج فيديوهات تلقائية</span></div>
          <div className="ai-feat"><span className="ai-feat-icon">✅</span><span>إدارة المهام والتاسكات</span></div>
          <div className="ai-feat"><span className="ai-feat-icon">📈</span><span>داشبورد تتبع وتحليل</span></div>
          <div className="ai-feat"><span className="ai-feat-icon">📅</span><span>جدولة ونشر تلقائي</span></div>
          <div className="ai-feat"><span className="ai-feat-icon">🔔</span><span>تتبع الأداء لحظة بلحظة</span></div>
          <div className="ai-feat"><span className="ai-feat-icon">🤝</span><span>تعاون الفريق بالكامل</span></div>
        </div>
        <a href="https://wa.me/201019268509" target="_blank" className="ai-platform-btn">
      ...
      <div className="ai-platform-visual">
        <div className="ai-dashboard-mock">
          <div className="mock-topbar">
            <div className="mock-dots"><span></span><span></span><span></span></div>
            <div className="mock-title">منصة ساعِد — لوحة التحكم</div>
          </div>
          <div className="mock-stats-row">
            <div className="mock-stat"><div className="mock-stat-num">١٢٤</div><div className="mock-stat-lbl">منشور هذا الشهر</div></div>
            <div className="mock-stat mock-stat-gold"><div className="mock-stat-num">٣٨ ألف</div><div className="mock-stat-lbl">وصول إجمالي</div></div>
            <div className="mock-stat"><div className="mock-stat-num">٨٩٪</div><div className="mock-stat-lbl">نسبة الإنجاز</div></div>
          </div>
          <div className="mock-content-row">
            <div className="mock-content-block">
              <div className="mock-content-header"><span className="mock-badge">🤖 AI</span><span className="mock-content-title">توليد محتوى</span></div>
              ...
              <div className="mock-gen-btn">توليد الآن ✨</div>
            </div>
            <div className="mock-tasks-block">
              <div className="mock-content-header"><span className="mock-content-title">المهام النشطة</span></div>
              <div className="mock-task mock-task-done">✓ تصميم بوست رمضان</div>
              <div className="mock-task mock-task-done">✓ فيديو حملة التبرع</div>
              <div className="mock-task mock-task-active">⟳ تقرير الأداء الأسبوعي</div>
              <div className="mock-task mock-task-pending">◯ محتوى يوم الوطني</div>
            </div>
          </div>
          <div className="mock-bar-chart">
            ...
            <div className="mock-bar mock-bar-active" style={{"height":"90%"}}></div>
...
{/* HOW WE WORK */}
<section id="how">
  <div className="fade-up" style={{"textAlign":"center","maxWidth":"700px","margin":"0 auto 1rem"}}>
    <span className="section-tag">منهجيتنا</span>
    <h2 className="section-title">كيف نعمل؟</h2>
    <p className="section-desc" style={{"margin":"0 auto","color":"rgba(255,255,255,0.65)"}}>
...
<section id="why">
  <div className="fade-up">
    <span className="section-tag">تميّزنا</span>
    <h2 className="section-title">لماذا ساعِد؟</h2>
    <p className="section-desc">ما يميّزنا عن غيرنا من الوكالات والمقدمين</p>
  </div>
...
<section id="impact">
  ...
  <div className="numbers-strip fade-up">
    <div className="big-num-item">
      <div className="big-num-value" data-target="10">0</div>
      <div className="big-num-plus">+</div>
      <div className="big-num-label">جمعية تحت إدارتنا<br />في المملكة العربية السعودية</div>
    </div>
    <div className="big-num-divider"></div>
    <div className="big-num-item">
      <div className="big-num-value" data-target="2" data-prefix="+">0</div>
      <div className="big-num-unit">مليون ريال</div>
      <div className="big-num-label">تمويلات محققة<br />لجمعياتنا الشريكة</div>
    </div>
    <div className="big-num-divider"></div>
    <div className="big-num-item">
      <div className="big-num-value" data-target="10000" data-comma="true">0</div>
      <div className="big-num-unit">ريال</div>
      <div className="big-num-label">تبرعات مجمّعة<br />عبر حملاتنا الرقمية</div>
    </div>
    <div className="big-num-divider"></div>
    <div className="big-num-item">
      <div className="big-num-value" data-target="6">0</div>
      <div className="big-num-plus">+</div>
      <div className="big-num-label">خدمات إعلامية متكاملة<br />تحت سقف واحد</div>
    </div>
  </div>

  <div className="fade-up" style={{"textAlign":"center","maxWidth":"700px","margin":"3rem auto 1rem"}}>
    <span className="section-tag">الأثر الذي نصنعه</span>
    <h2 className="section-title">ماذا يعني العمل معنا؟</h2>
    <p className="section-desc" style={{"margin":"0 auto"}}>نتائج ملموسة تنعكس على رسالة جمعيتكم ومجتمعكم</p>
  </div>
  <div className="impact-grid fade-up">
    <div className="impact-card">
      <div className="impact-icon">🏛️</div>
      <div className="impact-num">10 جمعيات</div>
      <div className="impact-label">تحت الإدارة الإعلامية الكاملة في المملكة</div>
    </div>
    <div className="impact-card">
      <div className="impact-icon">💵</div>
      <div className="impact-num">+2,000,000 ريال</div>
      <div className="impact-label">تمويلات محققة لجمعياتنا الشريكة</div>
    </div>
    <div className="impact-card">
      <div className="impact-icon">❤️</div>
      <div className="impact-num">10,000 ريال</div>
      <div className="impact-label">تبرعات مجمّعة عبر حملاتنا الرقمية</div>
    </div>
    <div className="impact-card">
      <div className="impact-icon">📡</div>
      <div className="impact-num">وصول أوسع</div>
      <div className="impact-label">لرسالة الجمعية لأكبر شريحة ممكنة من المجتمع</div>
    </div>
    <div className="impact-card">
      <div className="impact-icon">🔄</div>
      <div className="impact-num">متابع ← داعم</div>
      <div className="impact-label">تحويل المتابع إلى داعم وشريك فاعل</div>
    </div>
  </div>
</section>
...
<section id="target">
  <div className="fade-up" style={{"textAlign":"center","maxWidth":"700px","margin":"0 auto 1rem"}}>
    <span className="section-tag">الفئة المستهدفة</span>
    <h2 className="section-title">لمن نقدم خدماتنا؟</h2>
    <p className="section-desc" style={{"margin":"0 auto"}}>نختص في العمل مع جهات العمل الخيري والإنساني</p>
  </div>
  <div className="target-grid fade-up">
    <div className="target-card">
      <div className="target-card-icon">🕌</div>
      <h4>الجمعيات الخيرية</h4>
    </div>
    <div className="target-card">
      <div className="target-card-icon">🏛️</div>
...
{/* CTA */}
<section id="cta">
  <div className="cta-content fade-up" style={{"textAlign":"center"}}>
    <span className="section-tag">دعوة للتعاون</span>
    <h2 className="section-title" style={{"marginBottom":"1rem"}}>معًا… نُظهر الخير<br />ونُضاعف أثره</h2>
    <p className="section-desc">
    ...
    <div className="hero-btns" style={{"justifyContent":"center","marginTop":"2rem"}}>
      <a href="https://wa.me/201019268509" target="_blank" className="btn-primary" style={{"background":"#25d366","border":"none","color":"white"}}>
 ...
 <a href="https://drive.google.com/file/d/1Woa17q3C2o4_HGd3zdTAVoVzp2NjjeNh/view?usp=drive_link" target="_blank" className="btn-secondary">📄 الملف التعريفي</a>
      <a href="https://www.thebrightstation.com" target="_blank" className="btn-secondary">The Bright Station</a>
    </div>
  </div>
</section>
...
<footer>
  <div className="footer-grid">
    <div className="footer-brand">
      ...
      <p style={{"marginTop":"0.75rem"}}>مبادرة من <a href="https://www.thebrightstation.com" target="_blank" style={{"color":"var(--gold)","textDecoration":"none"}}>The Bright Station</a> للإعلان والتسويق</p>
    </div>
