...
export type LogoAnimation = "bounce" | "flyRight" | "flyLeft" | "flyTop" | "fadeScale" | "spin";

export type LogoPosition = "topLeft" | "topRight" | "center" | "bottomLeft" | "bottomRight";
...
export const POSITION_OFFSETS: Record<
  LogoPosition,
  {
    top?: number | string;
