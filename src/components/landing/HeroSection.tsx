  ...
  return (
    ...
    >
      ...
      <div className="fade-up" style={{ maxWidth: 650, position: "relative", zIndex: 2, flex: 1 }}>
        ...
        >
          مبادرة إعلامية وتسويقية متخصصة في دعم الجمعيات الخيرية السعودية، عبر تمكينها من الظهور
          الإعلامي المؤثر والاحترافي وتحويل رسالتها الإنسانية إلى قصص تصل للناس وتحرّكهم نحو التبرع
          والمشاركة.
        </p>
        ...
        >
          {STATS.map((s) => (
            <div key={s.label} style={{ textAlign: "center" }}>
              ...
              <div
                style={{ fontSize: "0.8rem", color: "rgba(255,255,255,0.5)", marginTop: "0.2rem" }}
              >
                {s.label}
              </div>
            </div>
