...
export function ImpactSection() {
  ...
  return (
    <section id="impact" style={{ background: "white" }} className="px-6 md:px-16 py-20 md:py-24">
      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div style={{ textAlign: "center", position: "relative", zIndex: 1 }}>
            <span className="big-num-value" data-target="10" style={numStyle}>
              0
            </span>
          ...
          {/* Stat 2 */}
          <div style={{ textAlign: "center", position: "relative", zIndex: 1 }}>
            <span className="big-num-value" data-target="2" data-prefix="+" style={numStyle}>
              0
            </span>
            <span
              style={{
          ...
          {/* Stat 3 */}
          <div style={{ textAlign: "center", position: "relative", zIndex: 1 }}>
            <span className="big-num-value" data-target="10000" data-comma="true" style={numStyle}>
              0
            </span>
            <span
              style={{
          ...
          {/* Stat 4 */}
          <div style={{ textAlign: "center", position: "relative", zIndex: 1 }}>
            <span className="big-num-value" data-target="6" style={numStyle}>
              0
            </span>
            <span style={supStyle}>+</span>
            <div style={subStyle}>
      ...
      <div
        className="fade-up grid gap-6 mt-12"
