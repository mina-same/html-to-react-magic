  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-8">
        <div>
          <h3
            style={{ color: "white", fontSize: "1.3rem", fontWeight: 800, marginBottom: "0.75rem" }}
          >
            ساعِد — SAAID
          </h3>
          <p style={{ fontSize: "0.85rem", lineHeight: 1.8, margin: 0 }}>
            مبادرة إعلامية وتسويقية متخصصة في دعم الجمعيات الخيرية السعودية. نحوّل رسالتك الإنسانية
            إلى أثر مجتمعي حقيقي.
          </p>
        ...
        <div>
          ...
          >
            <li>
              <a href="mailto:info@saaid-platform.com" style={linkStyle}>
