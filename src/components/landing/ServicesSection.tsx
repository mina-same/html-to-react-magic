  ...
  return (
    <section id="services" style={{ background: "white" }} className="px-6 md:px-16 py-20 md:py-24">
      ...
      <div className="fade-up text-center mx-auto mb-12" style={{ maxWidth: 700 }}>
        ...
        <p style={{ fontSize: "1.05rem", color: "#6b7280", lineHeight: 1.9, margin: "0 auto" }}>
      ...
      >
        ...
        >
          <div>
            ...
            >
              منصة متكاملة تجمع كل أدوات إدارة محتواك الخيري في مكان واحد — من توليد المحتوى والصور
              والفيديوهات بالذكاء الاصطناعي، إلى تتبع المهام والداشبورد التحليلي الكامل.
            </p>
            <div className="grid grid-cols-2 gap-2 mb-6">
              {AI_FEATURES.map((feat) => (
                ...
                >
                  ...
                  <span
                    style={{ fontSize: "0.82rem", color: "rgba(255,255,255,0.8)", fontWeight: 500 }}
                  >
                    {feat.label}
                  </span>
                </div>
          ...
          >
            ...
            >
              <div style={{ display: "flex", gap: 5 }}>
                {["rgba(255,95,87,0.7)", "rgba(255,189,68,0.7)", "rgba(40,200,64,0.7)"].map(
                  (c, i) => (
                    <span
                      key={i}
                      style={{
            ...
            <div className="grid grid-cols-3 gap-2 p-3">
              {[
                { v: "١٢٤", l: "منشور هذا الشهر", gold: false },
                { v: "٣٨ ألف", l: "وصول إجمالي", gold: true },
                { v: "٨٩٪", l: "نسبة الإنجاز", gold: false },
              ].map((s) => (
                <div
                  key={s.l}
                  style={{
                    background: s.gold ? "rgba(201,168,76,0.12)" : "rgba(255,255,255,0.05)",
                    border: s.gold ? "1px solid rgba(201,168,76,0.2)" : "none",
                    borderRadius: 10,
                    padding: "0.6rem",
                    textAlign: "center",
                  }}
            ...
            <div className="grid grid-cols-2 gap-2 px-3 pb-1">
              ...
              >
                ...
                {[
                  { t: "✓ تصميم بوست رمضان", c: "rgba(74,200,120,0.8)" },
                  { t: "✓ فيديو حملة التبرع", c: "rgba(74,200,120,0.8)" },
                  { t: "⟳ تقرير الأداء الأسبوعي", c: "rgba(255,200,60,0.8)" },
                  { t: "◯ محتوى يوم الوطني", c: "rgba(255,255,255,0.35)" },
                ].map((r, i) => (
                  <div key={i} style={{ fontSize: "0.65rem", padding: "3px 0", color: r.c }}>
                    {r.t}
                  </div>
                ))}
              </div>
              ...
              {BAR_HEIGHTS.map((h, i) => (
                <div
                  ...
                  style={{
                    ...
                    background: h === "90%" ? "rgba(201,168,76,0.5)" : "rgba(255,255,255,0.1)",
                    height: h,
                  }}
                />
              ))}
