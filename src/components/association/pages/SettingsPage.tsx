...
export default function SettingsPage({ assocName, onNameChange, onLogout }: Props) {
  ...
  useEffect(() => {
    ...
    contentGenerationsDb.list(user.id).then((rows) => {
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ background: "white", borderRadius: 13, border: "1px solid rgba(45,122,82,.12)", overflow: "hidden" }}>
        <div style={{ padding: "14px 18px", borderBottom: "1px solid rgba(45,122,82,.12)", display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            <div style={{ fontSize: ".92rem", fontWeight: 700, color: "#111827" }}>استخدام الذكاء الاصطناعي</div>
            <div style={{ fontSize: ".7rem", color: "#6b7280", marginTop: 1 }}>توليد المحتوى · gpt-4o-mini</div>
          </div>
        </div>

        <div style={{ padding: 20 }}>
          {statsLoading ? (
            <div style={{ display: "flex", alignItems: "center", gap: 8, color: "#9ca3af", fontSize: ".82rem" }}>
              <span style={{
                display: "inline-block", width: 14, height: 14, borderRadius: "50%",
                border: "2px solid #e5e7eb", borderTopColor: "#2d7a52",
            ...
            <>
              ...
              <div style={{ display: "flex", gap: 12, marginBottom: 18, flexWrap: "wrap" }}>
                <div style={{ flex: 1, minWidth: 110, padding: "14px 16px", borderRadius: 10, background: "#f0fdf4", border: "1px solid #bbf7d0" }}>
                  <div style={{ fontSize: ".67rem", fontWeight: 600, color: "#166534", textTransform: "uppercase", letterSpacing: ".05em", marginBottom: 5 }}>
                    إجمالي التوكنات
                  </div>
                ...
                <div style={{ flex: 1, minWidth: 110, padding: "14px 16px", borderRadius: 10, background: "#f8fafc", border: "1px solid #e2e8f0" }}>
                  <div style={{ fontSize: ".67rem", fontWeight: 600, color: "#475569", textTransform: "uppercase", letterSpacing: ".05em", marginBottom: 5 }}>
                    جلسات التوليد
                  </div>
                ...
                <div style={{ flex: 1, minWidth: 110, padding: "14px 16px", borderRadius: 10, background: "#f8fafc", border: "1px solid #e2e8f0" }}>
                  ...
                  <div style={{ fontSize: ".88rem", fontWeight: 700, color: "#1e293b", lineHeight: 1.3, marginTop: 4 }}>
              ...
              <div style={{ marginBottom: 6 }}>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                  <span style={{ fontSize: ".72rem", color: "#6b7280", fontWeight: 600 }}>الاستخدام مقابل 100K توكن</span>
                  <span style={{ fontSize: ".72rem", color: "#374151", fontWeight: 700 }}>{pct.toFixed(1)}%</span>
                </div>
