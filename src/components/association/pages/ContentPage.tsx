...
async function generateContent(
  ...
  const systemPrompt = `أنت كاتب محتوى تسويقي ومبدع بصري متخصص في المنظمات الخيرية. الجمعية: "${assocName}".
  استخدم السياق التالي عن الجمعية للرد بدقة:
  ---
  ${context}
  ---
  المطلوب:
  1. نص المحتوى (باللغة العربية).
  2. وصف بصري مقترح (صورة أو فيديو) يبدأ بكلمة "الوصف البصري:".
  `;
